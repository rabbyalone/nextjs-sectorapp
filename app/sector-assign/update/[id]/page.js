                ...
                <div className="p-5">
                    ...
                    <form onSubmit={handleSubmit} ref={formRef} className="max-w-sm">
                        ...
                        <div className='flex'>
                            ...
                            <button type='button' className="text-white bg-gray-400 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-3 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 ml-3"><Link href="/sector-assign/list">Cancel</Link></button>
                        </div>
