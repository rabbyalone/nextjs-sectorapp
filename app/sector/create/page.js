                ...
                <div className="p-5">
                    ...
                    <form onSubmit={handleSubmit} className="max-w-sm">
                        ...
                        <div className="mb-5">
                            ...
                            <CreatableSelect isMulti onChange={(newValue) => setValue(newValue)} placeholder="Write here to create new sector" required/>
                        </div>
                        <div className='flex'>
                            <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
                            <button type='button' className="text-white bg-gray-400 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-3 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 ml-3"><Link href="list">Cancel</Link></button>
                        </div>
                    </form>
                </div>
            </div>
